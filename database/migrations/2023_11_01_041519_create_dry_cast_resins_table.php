...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('dry_cast_resins', function (Blueprint $table) {
            ...
            $table->float('totalHour_coil_makinglv')->nullable();
            $table->float('totalHour_MouldCasting')->nullable();
            $table->float('totalHour_CoreCoilAssembly')->nullable();
            $table->float('totalHour_SusunCore')->nullable();
            $table->float('totalHour_Finishing')->nullable();
            $table->float('totalHour_Connection_Final_Assembly')->nullable();
            ...
            $table->float('hour_hv_moulding')->nullable();
            $table->float('hour_hv_casting')->nullable();
            $table->float('hour_hv_demoulding')->nullable();
            $table->float('hour_lv_bobbin')->nullable();
            $table->float('hour_lv_moulding')->nullable();
            $table->float('hour_touch_up')->nullable();
