...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('gpadrys', function (Blueprint $table) {
            ...
            $table->date('start_wc1')->nullable();
            $table->date('start_wc2')->nullable();
            $table->date('start_wc3')->nullable();
            $table->date('start_wc4')->nullable();
            $table->date('start_wc5')->nullable();
            $table->date('start_wc6')->nullable();
            $table->date('start_wc7')->nullable();
            $table->date('start_wc8')->nullable();
            $table->date('start_wc9')->nullable();
            $table->date('start_wc10')->nullable();
            $table->date('start_wc11')->nullable();
            $table->date('start_wc12')->nullable();
            $table->date('start_wc13')->nullable();
            $table->date('start_wc14')->nullable();
            $table->date('start_wc15')->nullable();
