...
class LeadtimeNoFinishingSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $csvFile = database_path('seeders\csv\leadtime_nofinishing.csv'); // Tentukan jalur ke file CSV Anda
        ...
        foreach ($csvData as $row) {
            ...
            DB::table('leadtime_nofinishings')->insert([
