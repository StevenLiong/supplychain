...
class LeadtimeWithFinishingOltcSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $csvFile = database_path('seeders\csv\leadtime_withfinishing_oltc.csv'); // Tentukan jalur ke file CSV Anda
        ...
        foreach ($csvData as $row) {
            ...
            DB::table('leadtime_withfinishingoltcs')->insert([
                ...
                'jeda_finishing_deadline' => $data['jeda_finishing_deadline'], // Sesuaikan dengan nama kolom Anda
