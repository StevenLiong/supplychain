...
class ManHourDrynonresin extends Seeder
{
    /**
    ...
    public function run(): void
    {
            ...
            $csvFile = database_path('seeders\csv\man_hour_drynonresin.csv'); // Tentukan jalur ke file CSV Anda
            ...
            foreach ($csvData as $row) {
                ...
                DB::table('manhour_drynonresins')->insert([
