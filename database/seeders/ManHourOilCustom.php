...
class ManHourOilCustom extends Seeder
{
    /**
    ...
    {
        $csvFile = database_path('seeders\csv\man_houur_oli_custom.csv'); // Tentukan jalur ke file CSV Anda
        ...
        foreach ($csvData as $row) {
            ...
            DB::table('man_hour_oil_customs')->insert([
