...
class ManHourOilstandard extends Seeder
{
    /**
    ...
    {
        $csvFile = database_path('seeders\csv\man_hour_oli_standard.csv'); // Tentukan jalur ke file CSV Anda
        ...
        foreach ($csvData as $row) {
            ...
            DB::table('man_hour_oilstandards')->insert([
