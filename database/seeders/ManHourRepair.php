...
class ManHourRepair extends Seeder
{
    /**
    ...
    {
        $csvFile = database_path('seeders\csv\man_hour_repair.csv'); // Tentukan jalur ke file CSV Anda
        ...
        foreach ($csvData as $row) {
            ...
            DB::table('man_hour_repairs')->insert([
