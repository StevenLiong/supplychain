                ...
                <div class="row">
                    <div class="col-lg-2 col-sm-6">
                        ...
                        <p class="p-0 m-0" style="color: #d02424" id="preview-total_hour">
                            <b>
                                    {{ $detail->dry_non_resin->total_hour }}
                            </b>
                        </p>
                    </div>
                    <div class="col-lg-2 col-sm-6">
                        ...
                        <p class="p-0 m-0" style="color: #d02424" id="preview-category">
                            <b>
                                {{ $detail->dry_non_resin->nama_product }}
                            </b>
                        </p>
                    </div>
                    <div class="col-lg-2 col-sm-6">
                        ...
                        <p class="p-0 m-0" style="color: #d02424" id="preview-ukuran_kapasitas">
                            <b>
                                {{ $detail->dry_non_resin->ukuran_kapasitas }}
                            </b>
                        </p>
                    </div>
                    <div class="col-lg-2 col-sm-6">
                    ...
                    <div class="col-lg-2 col-sm-6">
                        ...
                        <p class="p-0 m-0" style="color: #d02424" id="preview-so">
                            <b>
                                {{ $detail->dry_non_resin->kd_manhour }}
                            </b>
                        </p>
                    </div>
                </div>
                            ...
                            <div class="input-group input-group-md justify-content-center">
                                ...
                                <div class="input-group-append">
                                    <span type="text" class="input-group-text bg-warning" style="width: 3rem"
                                        ...
                                        {{ $detail->dry_non_resin->totalHour_coil_making }}
                            ...
                            <table class="w-100">
                                <tr !important>
                                    <td class="w-20">
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->hour_coil_lv }}
                                ...
                                <tr !important>
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->hour_coil_hv }}
                                ...
                                <tr !important>
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            id="preview-hour_coil_hv">
                                            {{ $detail->dry_non_resin->hour_potong_leadwire }}
                                    ...
                                    <td>
                                        <h6 class=" border bg-warning rounded p-1 text-center" id="preview-coil_hv">
                                            {{ $detail->dry_non_resin->potong_leadwire }}
                                ...
                                <tr !important>
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            id="preview-hour_coil_hv">
                                            {{ $detail->dry_non_resin->hour_potong_isolasi }}
                                    ...
                                    <td>
                                        <h6 class=" border bg-warning rounded p-1 text-center" id="preview-coil_hv">
                                            {{ $detail->dry_non_resin->potong_isolasi }}
                            ...
                            <div class="input-group input-group-md justify-content-center">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text bg-warning"
                                        id="preview-totalHour_MouldCasting">{{ $detail->dry_non_resin->totalHour_MouldCasting }}
                                </div>
                                <div class="input-group-append">
                                    <span class="input-group-text">HOUR</span>
                                </div>
                        ...
                        <div class="align-items-center justify-content-left pt-1 px-1">
                            <table class="w-100">
                                <tr !important>
                                    <td class="w-20">
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->hour_moulding_casting }}</h6>
                                    </td>
                                    <td class="w-30">
                                        <h6 class=" border border-dark rounded p-1 text-center">moulding_casting</h6>
                                    </td>
                                    <td class="w-50">
                                        <h6 class="border bg-warning rounded p-1 text-center" id="preview-moulding_casting">
                                            {{ $detail->dry_non_resin->moulding_casting }}</h6>
                                ...
                                <tr !important>
                                    <td>
                                        <h6 class=" border border-dark rounded p-1 text-center"
                                            id="preview-hour_oven">{{ $detail->dry_non_resin->hour_oven }}
                                        </h6>
                                    </td>
                                    <td>
                    ...
                    <div style="padding: 5px;">
                        <div class="row align-items-center ">
                            <div class="input-group input-group-md justify-content-center">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text bg-warning"
                                        id="preview-hour_qctesting">{{ $detail->dry_non_resin->totalHour_QCTest }}</span>
                                </div>
                                <div class="input-group-append">
                                    <span class="input-group-text">HOUR</span>
                                </div>
                                ...
                                <tr !important>
                                    <td class="w-20">
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->hour_qc_testing }}
                                        </h6>
                                    </td>
                                    <td class="w-30">
                                    ...
                                    <td>
                                        <h6 class=" border bg-warning rounded p-1 text-center"
                                            id="preview-qc_testing">{{ $detail->dry_non_resin->qc_testing }}
                                        </h6>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div style="padding: 5px;">
                        <div class="row align-items-center ">
                            <div class="input-group input-group-md justify-content-center">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text bg-warning"
                                        id="preview-totalHour_CoreCoilAssembly">{{ $detail->dry_non_resin->totalHour_CoreCoilAssembly }}</span>
                                </div>
                                <div class="input-group-append">
                                    <span class="input-group-text">HOUR</span>
                                </div>
                                ...
                                <tr !important>
                                    <td class="w-20">
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->hour_type_susun_core }}
                                        </h6>
                                    </td>
                                    <td class="w-30">
                                    ...
                                    <td class="w-50">
                                        <h6 class=" border bg-warning rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->type_susun_core }}</h6>
                                    </td>
                                </tr>
                                <tr !important>
                                    <td class="w-20">
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            id="preview-hour_type_susun_core">
                                            {{ $detail->dry_non_resin->hour_hv_connection }}
                                        </h6>
                                    </td>
                                    <td class="w-30">
                                    ...
                                    <td class="w-50">
                                        <h6 class=" border bg-warning rounded p-1 text-center"
                                            id="preview-hv_connection">
                                            {{ $detail->dry_non_resin->hv_connection }}</h6>
                                    </td>
                                </tr>
                                <tr !important>
                                    <td class="w-20">
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            id="preview-hour_type_susun_core">
                                            {{ $detail->dry_non_resin->hour_lv_connection }}
                                        </h6>
                                    </td>
                                    <td class="w-30">
                                    ...
                                    <td class="w-50">
                                        <h6 class=" border bg-warning rounded p-1 text-center"
                                            id="preview-lv_connection">
                                            {{ $detail->dry_non_resin->lv_connection }}</h6>
                                    </td>
                                </tr>
                                <tr !important>
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            id="preview-hour_wiring">{{ $detail->dry_non_resin->hour_wiring }}
                                        </h6>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <h6 class=" border bg-warning rounded p-1 text-center" id="preview-wiring">
                                            {{ $detail->dry_non_resin->wiring }}</h6>
                                    </td>
                                </tr>
                                <tr !important>
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->hour_instal_housing }}
                                        </h6>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <h6 class=" border bg-warning rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->instal_housing }}</h6>
                                ...
                                <tr !important>
                                    ...
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->hour_bongkar_housing }}
                                        </h6>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <h6 class=" border bg-warning rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->bongkar_housing }}</h6>
                                ...
                                <tr !important>
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->hour_pembuatan_cu_link }}
                                        </h6>
                                    </td>
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center">
                                    ...
                                    <td>
                                        <h6 class=" border bg-warning rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->pembuatan_cu_link }}</h6>
                                    </td>
                                </tr>
                                <tr !important>
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            id="preview-hour_others">{{ $detail->dry_non_resin->hour_others }}
                                        </h6>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <h6 class=" border bg-warning rounded p-1 text-center" id="preview-others">
                                            {{ $detail->dry_non_resin->others }}</h6>
                                    </td>
                                </tr>
                                <tr !important>
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->hour_accesories }}</h6>
                                    </td>
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center">
                                            Accessories</h6>
                                    ...
                                    <td>
                                        <h6 class=" border bg-warning rounded p-1 text-center"
                                            id="preview-accesories">{{ $detail->dry_non_resin->accesories }}
                                        </h6>
                                    </td>
                                </tr>
                                <tr !important>
                                    <td>
                                        <h6 class="border border-dark rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->hour_potong_isolasi_fiber }}
                                        </h6>
                                    ...
                                    <td>
                                        <h6 class=" border bg-warning rounded p-1 text-center"
                                            ...
                                            {{ $detail->dry_non_resin->potong_isolasi_fiber }}
                                        </h6>
                                    </td>
                                </tr>
                            </table>
