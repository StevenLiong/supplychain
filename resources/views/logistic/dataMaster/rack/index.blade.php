            ...
            <div class="card rounded-0 m-2 ">
                    ...
                    <div class="row justify-content-between mx-2">
                        ...
                        <div class="btn-create">
                            <button type="button" class="btn btn-xs btn-gray"
                                onclick=window.location="{{ url('datamaster/rak/create') }}">Tambah Data</button>
                        </div>
                        {{-- btn create end --}}

                        {{-- search --}}
                        <div>
                            <form action="{{ url('datamaster/rak') }}">
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm rounded-0"
                                        placeholder="cari kode rak.." name="search" value="{{ request('search') }}">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <button type="button" class="btn btn-xs btn-primary rounded-0"
                                                        onclick="window.location='{{ url('datamaster/rak/' . $item->id) }}'">
                ...
                <div class="row mx-3 mb-3">
                    <div class="col text-secondary">
                        ...
                        Showing {{ $rack->firstItem() }}
                        to {{ $rack->lastItem() }}
                        of {{ $rack->total() }}
                        data
                    </div>
                    <div class="col d-flex justify-content-end">
                        {{ $rack->appends(request()->input())->links() }}
                    </div>
                </div>
                {{-- pagination end --}}
            </div>
