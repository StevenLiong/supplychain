...
@section('content')
    <div class="content-wrapper bg-white">
        <div class="container-fluid">
            ...
            {{-- card tabel --}}
            <div class="card roundedd-0 m-2">
                <div class="card-header">
                    <div class="row justify-content-between mx-2">
                        {{-- btn create --}}
                        <div class="btn-create ">
                            <button type="button" class="btn btn-xs btn-gray"
                                onclick=window.location="{{ url('receiving/bpnb/create') }}">Create data</button>
                        </div>
                        {{-- btn create end --}}
                            ...
                            <form action="{{ url('receiving/incoming') }}">
                                <div class="input-group ">
                                    <input type="text" class="form-control form-control-sm rounded-0"
                                        placeholder="cari nomor bpnb..." name="search" value="{{ request('search') }}">
                                ...
                                @foreach ($bpnb as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('receiving/bpnb/print/' . $item->no_bon) }}">
