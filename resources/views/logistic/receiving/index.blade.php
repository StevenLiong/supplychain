...
@section('content')
    <div class="content-wrapper bg-white">
        <div class="container-fluid">
            ...
            <div class="card rounded-0 py-3 m-2">
                ...
                <div class="table-responsive px-3">
                    <form action="" method="post" class="form-receiving">
                        @csrf
                        <table class="table table-bordered table-hover">
                            <thead class="table-secondary">
                                <tr class="text-center">
                                    ...
                                    <th>Nama Material</th>
                                    <th>Nama Supplier</th>
                                    <th width="5%">Qty Kedatangan</th>
                                    <th width="3%">batch Kedatangan</th>
                                    <th>Cetak</th>
                                    <th>Aksi</th>
                                </tr>
                            </thead>
                                ...
                                @foreach ($incoming as $key => $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('receiving/incoming/print/' . $item->id) }}" target="_blank">
                                        ...
                                        <td class="">
                                            <div class="btn-group">
                                                ...
                                                {{-- edit end --}}
                                                {{-- hapus --}}
                                                <form action="{{ url('receiving/incoming/' . $item->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
                ...
                {{-- pagination --}}
                <div class="row  mx-3">
                    <div class="col p-0 text-secondary">
