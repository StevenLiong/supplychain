            ...
            <div class="card rounded-0 m-2">
                <div class="card-header">
                    <div class="row justify-content-between mx-2">
                        ...
                        {{-- search --}}
                        <div class="">
                            <form action="{{ url('receiving/incoming') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                            ...
                            <table class="table table-sm table-bordered table-hover">
                                ...
                                <tbody>
                                    @foreach ($incoming as $key => $item)
                                        <tr>
                                            <td class="text-center">{{ $incoming->firstItem() + $key }}</td>
                                            <td>{{ $item->no_po }}</td>
                                            <td>{{ $item->no_surat_jalan }}</td>
                                            <td>{{ $item->materialRak->material->kd_material }}</td>
                                            <td>{{ $item->materialRak->material->nama_material }}</td>
                                            <td>{{ $item->supplier->nama_supplier }}</td>
                                            <td class="text-center">{{ $item->qty_kedatangan }}</td>
                                            <td class="text-center">{{ $item->batch_datang }}</td>
                        ...
                        @else
                            <p class="text-center bordered">Tidak Ada Data</p>
                        @endif
                    </div>
