...
@section('content')
    <div class="content-wrapper bg-white">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 px-3">
                    <form action="{{ url('storage/rawmaterial/listmaterial/'. $materialRak->id) }}" method="post">
                        @csrf
                        @method('put')
                                    ...
                                    <select name="material_id" id="material_id"
                                        ...
                                        @foreach ($material as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('material_id') == $item->id || $materialRak->material_id == $item->id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3 p-2">
                                    ...
                                    <input type="number"
                                        ...
                                        is-invalid
                                    @enderror"
                                        name="qty_rak" id="qty_rak" value="{{ old('qty_rak', $materialRak->qty_rak) }}">
                                    @error('qty_rak')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
