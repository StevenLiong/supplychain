        ...
        <div class="container-fluid">
            ...
            <div class="btn-create px-3 mb-3">
                <button type="button" class="btn btn-sm btn-gray"
                    onclick=window.location="{{ url('storage/listmaterial/create') }}">Plot Material</button>
            </div>
                                ...
                                <td class="text-center ">
                                    <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-xs btn-warning rounded-0 "
                                            onclick="window.location='{{ url('storage/listmaterial/'.$item->id. '/edit') }}'">
                                        ...
                                        {{-- hapus --}}
                                        <form action="{{ url('storage/listmaterial/' . $item->id) }}" method="post">
                                            @csrf
                                            @method('delete')
