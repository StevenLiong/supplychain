...
<div class="col-sm-12">
    <div class="card">
        ...
        <div class="row mb-4 align-items-center">
            <div class="dropdown status-dropdown ml-4 mt-4 dropdown-toggl" id="dropdownMenuButton03" data-toggle="dropdown"
                aria-expanded="false">
                <form action="{{ route('bulan.periode') }}" method="post" id="periodeForm">
                    @csrf
                    <label for="bulanPeriode">Pilih Bulan:</label>
                    <select class="custom-select " name="periode" id="bulanPeriode"><i
