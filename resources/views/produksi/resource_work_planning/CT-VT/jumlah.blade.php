        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-4 align-items-center">
                    ...
                    <div class="dropdown status-dropdown ml-2 dropdown-toggl" id="dropdownMenuButton04"
                        data-toggle="dropdown" aria-expanded="false">
                        <div class="btn btn-primary">Shift<i class="ri-arrow-down-s-line ml-2 mr-0"></i></div>
                        <div class="dropdown-menu dropdown-menu" aria-labelledby="dropdownMenuButton04">
