            ...
            <div class="card rounded m-0" style="border-left-color: red; border-left-width: 10px;">
                <div class="card-body shadow">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <h6>Kode Manhour</h6>
                            <p class="p-0 m-0" style="color: #d02424" id="preview-so"><b>{{ $product->kd_manhour }}</b></p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="align-items-center justify-content-left pt-1 px-1">
                                <table class="w-100">
                                    ...
                                    <tr !important>
                                        <td>
                                            <h6 class=" border border-dark rounded p-1 text-center"
                                                id="preview-hour_oven">{{ $product->hour_oven }}
                                            </h6>
                                        </td>
                                        <td>
                            ...
                            <div class="align-items-center justify-content-left pt-1 px-1">
                                <table class="w-100">
                                    <tr !important>
                                        <td class="w-20">
                                            <h6 class="border border-dark rounded p-1 text-center"
                                                id="preview-hour_qc_testing">{{ $product->hour_qc_testing }}
                                            </h6>
                                        </td>
                                        <td class="w-30">
                                        ...
                                        <td>
                                            <h6 class=" border bg-warning rounded p-1 text-center"
                                                id="preview-qc_testing">{{ $product->qc_testing }}</h6>
                                        </td>
                                    </tr>
                                </table>
                            </div>
