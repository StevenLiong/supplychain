...
@section('content')
    <form class="login-content floating-label " method="post" action="{{ route('dryresin.detail', $product->id) }}">
        @method('PUT')
        @csrf
        <div class="row px-2">
            <div class="col-lg-12">
                                        ...
                                        <tr !important>
                                            ...
                                            <td class="w-50">
                                                <select
                                                    ...
                                                    onchange="showSelected('coil_lv')" disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('coil_hv')" disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('potong_leadwire')" disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('hv_moulding')" disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('hv_casting')" disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('hv_demoulding')" disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('lv_bobbin')" multiple disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('lv_moulding')" multiple disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('type_susun_core')" disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('wiring')" disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('instal_housing')" disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('bongkar_housing')" disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('pembuatan_cu_link')" disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td style="width:500px ">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('accessories')" multiple disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td style="width:500px ">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('potong_isolasi_fiber')" multiple disabled>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('routine_test')" multiple disabled>
                                                    @php
