...
@section('content')
    <div style="margin-bottom:350px; margin-top:10px;">
        <form class="login-content floating-label " method="post" action="{{ route('drynonresin.update', $product->id) }}">
        @method('PUT')
        @csrf
        <div class="row px-2">
            <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="floating-label form-group">
                                <input class="floating-input form-control" type="text" placeholder="" name="nomor_so"
                                    value="{{ old('nomor_so', $product->nomor_so) }}" id="so" readonly>
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="floating-label form-group">
                                ...
                                <label style="border-radius: 40px;">Kode Finish Good</label>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row align-items-center ">
                                    <div class="input-group input-group-md justify-content-center">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            >{{ $product->totalHour_coil_making }}</span>
                                        </div>
                                        <div class="input-group-append">
                                ...
                                <div class="align-items-center justify-content-left pt-1 px-1">
                                    <table class="w-100">
                                            ...
                                            <td class="w-50">
                                                <select
                                                    ...
                                                    @php
                                                            ...
                                                            $manhourData = $manhour
                                                                ->where('nama_kategoriproduk', 'DRY TYPE NON RESIN')
                                        ...
                                        <tr !important>
                                            <!-- tampilan hour dari inputan  -->
                                            <td>
                                                <p  type="text" class="border border-dark rounded text-center" style="width:100%;"
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                ...
                                                id="selectedInfo_potong_leadwire">0</p>
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <p class="border border-dark rounded text-center" style="width:100%;"
                                                id="selectedInfo_potong_isolasi" >0</p>
                                ...
                                <div class="align-items-center justify-content-left pt-1 px-1">
                                    <table class="w-100">
                                        <tr !important>
                                            ...
                                            <td class="w-20">
                                                <p type="text" class="border border-dark rounded text-center" style="width:100%;"
                                                id="selectedInfo_moulding_casting">0</p>
                                            </td>
                                            <!-- nama proses-->
                                            <td class="w-30">
                                            ...
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('moulding_casting')">
                                                    @php
                                                            $selectedValue = old('moulding_casting', $product->moulding_casting);
                                                            $manhourData = $manhour
                                                                ->where('nama_kategoriproduk', 'DRY TYPE NON RESIN')
                                                                ->where('nama_workcenter', 'MOULD & CASTING')
                                                                ->where('nama_proses', 'MOULDING & CASTING')
                                                                ->unique('nama_tipeproses');
                            ...
                            <div style="padding: 5px;">
                                ...
                                <div class="row align-items-center ">
                                    <div class="input-group input-group-md justify-content-center">
                                        ...
                                        <div class="input-group-append">
                                            <span type="text" class="input-group-text bg-warning" style="width: 3rem" id="totalQCTest_value"></span>
                                        </div>
                                        <div class="input-group-append">
                                            <span class="input-group-text">HOUR</span>
                                        </div>
                                ...
                                <div class="align-items-center justify-content-left pt-1 px-1">
                                    <table class="w-100">
                                        <tr !important>
                                            ...
                                            <td class="w-20">
                                                <p type="text" class="border border-dark rounded text-center" style="width:100%;"
                                                id="selectedInfo_qc_testing">0</p>
                                            ...
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('qc_testing')"
                                                    multiple>
                                                    @php
                                                            $selectedValue = old('qc_testing', $product->qc_testing);

                                                            $manhourData = $manhour
                                                                ->where('nama_kategoriproduk', 'DRY TYPE NON RESIN')
                                                                ->where('nama_workcenter', 'QC TEST')
                                                                ->where('nama_proses', 'QC TESTING')
                                                                ->unique('nama_tipeproses');
                                                        @endphp
                            ...
                            <div style="padding: 5px;">
                                ...
                                <div class="row align-items-center ">
                                    <div class="input-group input-group-md justify-content-center">
                                        ...
                                        <div class="input-group-append">
                                            <span type="text" class="input-group-text bg-warning" style="width: 3rem" id="totalCoreCoilAssembly_value"></span>
                                        </div>
                                        <div class="input-group-append">
                                            <span class="input-group-text">HOUR</span>
                                        </div>
                                ...
                                <div class="align-items-center justify-content-left pt-1 px-1">
                                    <table class="w-100">
                                        ...
                                        <tr !important>
                                            ...
                                            <td class="w-20">
                                                <p type="text" class="border border-dark rounded text-center" style="width:100%;"
                                                id="selectedInfo_hv_connection">0</p>
                                            ...
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    style="height: 33px;" id="hv_connection"
                                                    onchange="showSelected('hv_connection')">
                                                    @php
                                                            $selectedValue = old('hv_connection', $product->hv_connection);

                                                            $manhourData = $manhour
                                                                ->where('nama_kategoriproduk', 'DRY TYPE NON RESIN')
                                                                ->where('nama_workcenter', 'CORE COIL ASSEMBLY')
                                                                ->where('nama_proses', 'HV CONNECTION')
                                                                ->unique('nama_tipeproses');
                                                        @endphp
                                                        @if (count($manhourData) > 0)
                                                            @foreach ($manhourData as $data)
                                        ...
                                        <tr !important>
                                            ...
                                            <td class="w-20">
                                                <p type="text" class="border border-dark rounded text-center" style="width:100%;"
                                                id="selectedInfo_lv_connection">0</p>
                                                </td>
                                            <!-- nama proses-->
                                            <td class="w-30">
                                            ...
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    onchange="showSelected('lv_connection')">
                                                    @php
                                                            $selectedValue = old('lv_connection', $product->lv_connection);

                                                            $manhourData = $manhour
                                                                ->where('nama_kategoriproduk', 'DRY TYPE NON RESIN')
                                                                ->where('nama_workcenter', 'CORE COIL ASSEMBLY')
                                                                ->where('nama_proses', 'LV CONNECTION')
                                                                ->unique('nama_tipeproses');
                                                        @endphp
                                                        @if (count($manhourData) > 0)
                                                            @foreach ($manhourData as $data)
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <p type="text" class="border border-dark rounded text-center" style="width:100%;"
                                                id="selectedInfo_instal_housing">0</p>
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <p type="text" class="border border-dark rounded text-center" style="width:100%;"
                                                id="selectedInfo_bongkar_housing">0</p>
                                            </td>
                                            <!-- nama proses-->
                                            <td>
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <p type="text" class="border border-dark rounded text-center" style="width:100%;"
                                                id="selectedInfo_pembuatan_cu_link">0</p>
                                            ...
                                            <td>
                                                ...
                                                <select class=" form-control border border-dark rounded text-center"
                                                    ...
                                                    id="pembuatan_cu_link" onchange="showSelected('pembuatan_cu_link')">
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td style="width:500px ">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    name="others[]" id="others" onchange="showSelected('others')" multiple>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <input class="border border-dark rounded text-center" style="width:100%;"
                                                id="selectedInfo_accesories">0</p>
                                            </td>
                                            <!-- nama proses-->
                                            <td>
                                            ...
                                            <td style="width:500px ">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    name="accesories[]" id="accesories" onchange="showSelected('accessories')" 
                                                    multiple>
                                                    @php
                                        ...
                                        <tr !important>
                                            ...
                                            <td>
                                                <p type="text" class="border border-dark rounded text-center" style="width:100%;"
                                                id="selectedInfo_potong_isolasi_fiber" >0</p>
