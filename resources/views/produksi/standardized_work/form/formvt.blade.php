...
@section('content')
    ...
    <form class="login-content floating-label " method="post" action="{{ route('store.vt') }}">
        @csrf
        <div class="row px-2">
            <div class="col-lg-12">
                            ...
                            <div class="floating-label form-group">
                                <select class="floating-input form-control form-select input"name="ukuran_kapasitas"
                                    ...
                                    @php
                                        ...
                                        $manhourData = $manhour->where('id_kategori_produk', '4')->unique('ukuran_kapasitas');
                                    @endphp
                                ...
                                <div class="align-items-center justify-content-left pt-1 px-1">
                                    <table class="w-100">
                                        <tr !important>
                                            ...
                                            <td class="w-30">
                                                <h6 class=" border border-dark rounded p-1 text-center">Core Coil Assembly & Balut VT</h6>
                                            </td>
                                            <td class="w-50">
                                                <select
                                        ...
                                        <tr !important>
                                            ...
                                            <td class="w-30">
                                                <h6 class=" border border-dark rounded p-1 text-center">Buat & Pasang Shielding</h6>
                                            </td>
                                            <td class="w-50">
                                                <select
                                                    class="form-control form-select input border border-dark rounded text-center"
                                                    style="height: 33px;" name="buat_pasangshelding" id="buat_pasangshelding">
                                                </select>
                                            </td>
                                        </tr>
                                        <tr !important>
                                            ...
                                            <td class="w-30">
                                                <h6 class=" border border-dark rounded p-1 text-center">Koneksi CT Dan VT</h6>
                                            </td>
                                            <td class="w-50">
                                                <select
                                                    class="form-control form-select input border border-dark rounded text-center"
                                        ...
                                        <tr !important>
                                            <td class="w-20">
                                                <p class="border border-dark rounded text-center" style="width:100%;"
                                                    id="selectedInfo_gulungcoil_sekundervt_manual">0</p>
                                            </td>
                                            <td class="w-30">
                                                <h6 class=" border border-dark rounded p-1 text-center">Gulung Coil Sekunder VT Manual</h6>
                                            </td>
                                            <td class="w-50">
                                                <select
                                                    class="form-control form-select input border border-dark rounded text-center"
                                                    style="height: 33px;" name="gulungcoil_sekundervt_manual" id="gulungcoil_sekundervt_manual">
                                                </select>
                                            </td>
                                        </tr>
                                        <tr !important>
                                            <td class="w-20">
                                                <p class="border border-dark rounded text-center" style="width:100%;"
                                                    id="selectedInfo_buat_coilprimervt_menggunakanmesin">0</p>
                                            </td>
                                            <td class="w-30">
                                                <h6 class=" border border-dark rounded p-1 text-center">Buat Coil Primer VT Menggunakan Mesin</h6>
                                            </td>
                                            <td class="w-50">
                                                <select
                                                    class="form-control form-select input border border-dark rounded text-center"
                                                    style="height: 33px;" name="buat_coilprimervt_menggunakanmesin" id="buat_coilprimervt_menggunakanmesin">
                                                </select>
                                            </td>
                                        </tr>
                                        <tr !important>
                                            ...
                                            <td class="w-30">
                                                <h6 class=" border border-dark rounded p-1 text-center">Gulung Coil Primer Cut Core</h6>
                                            </td>
                                            <td class="w-50">
                                                <select
                                                    class="form-control form-select input border border-dark rounded text-center"
                                                    style="height: 33px;" name="gulungcoilprimer_cutcore" id="gulungcoilprimer_cutcore">
                                                </select>
                                            </td>
                                        </tr>
                                        <tr !important>
                                            ...
                                            <td class="w-30">
                                                <h6 class=" border border-dark rounded p-1 text-center">Gulung Coil Primer No Cut Core</h6>
                                            </td>
                                            <td class="w-50">
                                                <select
                                                    class="form-control form-select input border border-dark rounded text-center"
                                                    style="height: 33px;" name="gulungcoilprimer_nocutcore" id="gulungcoilprimer_nocutcore">
                                                </select>
                                            </td>
                                        </tr>
                                ...
                                <div class="align-items-center justify-content-left pt-1 px-1">
                                    <table class="w-100">
                                        <tr !important>
                                            <td class="w-20">
                                                <p type="text" class="border border-dark rounded p-1 text-center"
                                                    style="width:100%;" id="selectedInfo_prosesmouldassembly_typevt"> 0</p>
                                            </td>
                                            <td class="w-30">
                                                <h6 class=" border border-dark rounded p-1 text-center">Proses Mould Assembly Type VT</h6>
                                            </td>
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    style="height: 33px;"name="prosesmouldassembly_typevt" id="prosesmouldassembly_typevt">
                                                </select>
                                            </td>
                                        </tr>
                                        <tr !important>
                                            ...
                                            <td class="w-30">
                                                <h6 class=" border border-dark rounded p-1 text-center">Proses Pengovenan</h6>
                                            </td>
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                        ...
                                        <tr !important>
                                            ...
                                            <td class="w-30">
                                                <h6 class=" border border-dark rounded p-1 text-center">Proses Pembuatan Material</h6>
                                            </td>
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    style="height: 33px;"name="proses_pembuatanmaterial" id="proses_pembuatanmaterial">
                                                </select>
                                            </td>
                                        </tr>
                                        <tr !important>
                                        ...
                                        <tr !important>
                                            ...
                                            <td class="w-30">
                                                <h6 class=" border border-dark rounded p-1 text-center">Proses demoulding</h6>
                                            </td>
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                ...
                                <div class="align-items-center justify-content-left pt-1 px-1">
                                    <table class="w-100">
                                        ...
                                        <tr !important>
                                            ...
                                            <td class="w-30">
                                                <h6 class="border border-dark rounded p-1 text-center">Proses Accessories</h6>
                                            </td>
                                            <td class="w-50">
                                                <select class=" form-control border border-dark rounded text-center"
                                                    style="height: 33px;" id="proses_accessories" name="proses_accessories">
                                                </select>
                                            </td>
                                        </tr>
                                        <tr !important>
        ...
        $(document).ready(function() {
            function fillSelect(elementId, data, selectedProses, selectedWorkcenter) {
                var filteredData = data.filter(function(item) {
                    return (
                        item.nama_kategoriproduk === 'CT/VT' &&
                ...
                if (ukuran_kapasitas) {
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data) {
                                fillSelect('#cca_balutvt', data, 'CORE COIL ASSEMBLY & BALUT VT', 'COIL MAKING');
                                fillSelect('#buat_pasangshelding', data, 'BUAT & PASANG SHIELDING',
                                    'COIL MAKING');
                                fillSelect('#gulungcoil_sekundervt_manual', data, 'GULUNG COIL SEKUNDER VT MANUAL',
                                    'COIL MAKING');
                                fillSelect('#buat_coilprimervt_menggunakanmesin', data, 'GULUNG COIL SEKUNDER VT MENGGUNAKAN MESIN',
                                    'COIL MAKING');
                                fillSelect('#koneksi_ctvt', data, 'KONEKSI CT DAN VT',
                                    'COIL MAKING');
                                fillSelect('#solder', data, 'SOLDER',
                                    'COIL MAKING');
                                fillSelect('#gulungcoilprimer_cutcore', data, 'GULUNG COIL PRIMER CUT CORE',
                                    'COIL MAKING');
                                fillSelect('#gulungcoilprimer_nocutcore', data, 'GULUNG COIL PRIMER NO CUT CORE',
                                    'COIL MAKING');
                                fillSelect('#prosesmouldassembly_typect', data, 'PROSES MOULD ASSEMBLY TYPE CT',
                                    'MOULD & CASTING');
                                fillSelect('#prosesmouldassembly_typevt', data, 'PROSES MOULD ASSEMBLY TYPE VT',
                                    'MOULD & CASTING');
                                fillSelect('#proses_pengovenan', data, 'PROSES PENGOVENAN',
                                    'MOULD & CASTING');
                                fillSelect('#proses_pembuatanmaterial', data, 'PROSES PEMBUATAN MATERIAL',
                                    'MOULD & CASTING');
                                ...
                                fillSelect('#proses_cat', data, 'PROSES CAT',
                                    'FINAL ASSEMBLY');
                                fillSelect('#proses_accessories', data, 'PASANG ACESORIS', 'FINAL ASSEMBLY');
                                ...
                                $('#gulungcoil_sekundervt_manual').on('change', function() {
                                    showSelected('gulungcoil_sekundervt_manual');
                                });
                                $('#buat_coilprimervt_menggunakanmesin').on('change', function() {
                                    showSelected('buat_coilprimervt_menggunakanmesin');
                                });
