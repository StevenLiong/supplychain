...
Route::middleware(['auth', 'standardizedwork'])->group(function () {
    ...
    Route::get('/standardized_work/Detail-Data/{kd_manhour}', [StandardizeWorkController::class, 'detail'])->name('detail');
    Route::get('/standardized_work/Edit-Data/{kd_manhour}', [StandardizeWorkController::class, 'edit'])->name('edit');
    Route::put('/standardized_work/Edit-Data/{kd_manhour}', [StandardizeWorkController::class, 'update'])->name('update');
